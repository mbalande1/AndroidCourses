...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NumberViewHolder(View itemView) {
            ...
            // Attach onClickListener to this view item, on the View passed into the constructor (use 'this' as the OnClickListener),
            // because the onClick listener is implemented in this class
        ...
        public void onClick(View view) {
            ...
            // Trigger our onItemClickListener, which was implemented in the MainActivity, passing in the current items position
