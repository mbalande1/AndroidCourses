...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    /*  Called when the RecyclerView instantiates a new ViewHolder instance
        It is responsible for creating the Views, either by inflating the item views from XML OR creating them in code.
        It then returns a new ViewHolder object associated with this new view.
     */
    @Override
    ...
    // Called when the RecyclerView wants to populate the view data from our model (binding the data to View item),
