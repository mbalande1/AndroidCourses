...
public class NotificationUtils {
    // This PendingIntent request code is used to uniquely reference the PendingIntent
    private static final int WATER_REMINDER_NOTIFICATION_PENDING_INTENT_REQUEST_CODE = 123;
    // This notification id can be used to access our notifications after we've displayed it
    ...
    // This notification channel is used to link notifications to this channel
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String channelName = context.getString(R.string.main_notification_channel_name);
            NotificationChannel notifChannel = new NotificationChannel(WATER_REMINDER_NOTIFICATION_CHANNEL_ID, channelName, NotificationManager.IMPORTANCE_HIGH);
            // Add this channel to the NotificationManager
            notifManager.createNotificationChannel(notifChannel);
        }
        
        // In the remindUserBecauseCharging method use NotificationCompat.Builder to create a notification
        // that:
        ...
        NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            // This will guarantee the heads-up popup display
        ...
        notifManager.notify(WATER_REMINDER_NOTIFICATION_ID, notifBuilder.build());
    }
    ...
    public static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(
                context,
                WATER_REMINDER_NOTIFICATION_PENDING_INTENT_REQUEST_CODE,
                intentToLaunchMainActivity,
