...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_JSON_SEARCH = "jsonSearch";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(KEY_JSON_SEARCH)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(KEY_JSON_SEARCH));
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // Store the contents of the TextViews in the outState bundle
        outState.putString(KEY_QUERY_URL, mUrlDisplayTextView.getText().toString());
        outState.putString(KEY_JSON_SEARCH, mSearchResultsTextView.getText().toString());
    }
