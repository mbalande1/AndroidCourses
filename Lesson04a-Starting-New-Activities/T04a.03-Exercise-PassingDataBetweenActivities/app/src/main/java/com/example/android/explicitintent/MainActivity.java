    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String editTextValue = mNameEntry.getText().toString();
                /*
                ...
                // Use the putExtra method to put the String from the EditText in the Intent (the 'key' can be anything)
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, editTextValue);
                /*
