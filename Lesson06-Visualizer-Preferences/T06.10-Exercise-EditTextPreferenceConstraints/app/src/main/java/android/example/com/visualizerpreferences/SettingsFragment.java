...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        // Add the OnPreferenceChangeListener specifically to the Size multiplier preference
        // Set 'this' as the listener, as 'this' class implements the onPreferenceChange
    ...
    // to a float check that the float is between 0 (exclusive) and 3 (inclusive). If it isn't, show
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference.getKey().equals(sizeKey)) {
            Toast toastError = Toast.makeText(getContext(), "Please select a number between 0.1 and 3", Toast.LENGTH_SHORT);
