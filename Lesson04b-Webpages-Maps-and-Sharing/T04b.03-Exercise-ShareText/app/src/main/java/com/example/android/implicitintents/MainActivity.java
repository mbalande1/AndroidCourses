...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textToShare = "Hello world. Sharing is caring!";
    ...
    private void shareText(String textToSend) {

        String mimeType = "text/plain";
        // A title for the chooser window that will pop up
        String chooserTitle = "This is a test title";

        // Use ShareCompat.IntentBuilder to build the Intent and start the chooser - NO LONGER MAINTAINED
        //ShareCompat.IntentBuilder.from(this).setType(mimeType).setChooserTitle(chooserTitle).startChooser();
        ...
        // Create a chooser window, for this intent
