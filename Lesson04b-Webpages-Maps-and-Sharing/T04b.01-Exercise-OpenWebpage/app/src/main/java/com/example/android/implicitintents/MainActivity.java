...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        // A String that contains a URL ( make sure it starts with http:// or https:// )
    ...
    private void openWebPage(String urlString) {
        ...
        // Verify that this Intent can be launched from this device and then call startActivity
