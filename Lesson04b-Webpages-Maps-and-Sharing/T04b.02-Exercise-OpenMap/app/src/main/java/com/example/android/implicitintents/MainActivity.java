...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String addressQuery = "38 Harford Gardens, Tredegar";

        // Use Uri.Builder with the appropriate scheme and query to form the Uri for the address
        Uri.Builder builder = new Uri.Builder();
        builder.scheme("geo")
                .path("0,0")            // lat and long needs to be 0, if you are providing the street address query
                .appendQueryParameter("q", addressQuery);
